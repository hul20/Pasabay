...
class _RequesterActivityPageState extends State<RequesterActivityPage> {
  String _selectedTab = 'My Requests'; // My Requests or History
  ...
  Future<void> _loadRequests() async {
    ...
    try {
      ...
      for (var request in requests) {
        ...
        } else if (request.status == 'Completed' || request.status == 'Rejected' || request.status == 'Cancelled') {
  ...
  Widget _buildTravelerCard({
    ...
    return GestureDetector(
      onTap: () {
        ...
        // Navigate to traveler detail - needs Trip object
        // This should be updated to use actual Trip data
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Feature coming soon: View traveler details'),
